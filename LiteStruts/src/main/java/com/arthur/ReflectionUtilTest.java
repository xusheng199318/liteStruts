...
public class ReflectionUtilTest {
	...
	public void testGetSetterMethod() throws ClassNotFoundException {
		String name = "com.arthur.LoginAction";
		...
		Set<String> acctualNames = new HashSet<String>();
	...
	@Test
	public void testSetParameters() throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchFieldException, SecurityException {
